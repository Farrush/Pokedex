...
app.get('/',(req: Request, res: Response)=>{
    res.send('<h1>Poke API</h1><a href="/nav-list">nav-list</a><br/><a href="/pokemon/0025">pokemon</a>')
})
...
app.get('/nav-list', (req: Request, res:Response) => {
    ...
    db.all('select codigo, nome, icon from pokemons', [], (err: any, rows: IListaPoke[]) => {
        if (err) {
